	...
	<body>
		...
		<div id="show-platform" class="content scaffold-show" role="main">
			...
			<ol class="property-list platform">
				...
				<g:if test="${platformInstance?.platformName}">
				<li class="fieldcontain">
					<span id="platformName-label" class="property-label"><g:message code="platform.platformName.label" default="Platform Name" /></span>
					
						<span class="property-value" aria-labelledby="platformName-label"><g:fieldValue bean="${platformInstance}" field="platformName"/></span>
