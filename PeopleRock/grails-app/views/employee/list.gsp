			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="costCentre" title="${message(code: 'employee.costCentre.label', default: 'Cost Centre')}" />
					
						<g:sortableColumn property="hireDate" title="${message(code: 'employee.hireDate.label', default: 'Hire Date')}" />
					
						<th><g:message code="employee.employeeLeader.label" default="Employee Leader" /></th>
					
						<g:sortableColumn property="employmentStatus" title="${message(code: 'employee.employmentStatus.label', default: 'Employment Status')}" />
				...
				<g:each in="${employeeInstanceList}" status="i" var="employeeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: employeeInstance, field: "costCentre")}</td>
					
						<td><g:formatDate date="${employeeInstance.hireDate}" /></td>
					
						<td>${fieldValue(bean: employeeInstance, field: "employeeLeader")}</td>
					
						<td>${fieldValue(bean: employeeInstance, field: "employmentStatus")}</td>
